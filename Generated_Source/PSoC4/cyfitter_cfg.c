...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL5, 0x00005F00u);
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL3, 0x00001200u);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_PERI_PCLK_CTL14), 0x00000045u);
	...
	CyIntEnable(11u);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_WCO_WDT_MATCH), 0x00009C3Fu);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_WCO_WDT_CONFIG), 0x00000005u);
	CySysClkSetTimerSource(CY_SYS_CLK_TIMER_SRC_ILO);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_WCO_WDT_CONTROL), 0x00000008u);
	while ((CY_GET_XTND_REG32((void CYFAR *)(CYREG_WCO_WDT_CONTROL)) & 0x00000008u) != 0u) { }
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_WCO_WDT_CONTROL), 0x00000001u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_UAB0VREF_SW, 0x01010000u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_PERI_TR_GROUP0_TR_OUT_CTL0), 0x00000001u);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT0_PC2), 0x00000028u);
